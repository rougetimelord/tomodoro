...
var aboutFunc = function() {
  ...
  if(shown)
  {
    ...
    document.getElementById('disp').style = "-webkit-transition: 1s ease-in-out; -webkit-transform: scale(1);"
    document.getElementById('about').innerHTML="";
    shown=false;;
  }
  else
  {
    document.getElementById('disp').style = "-webkit-transition: 1s ease-in-out; -webkit-transform: scale(.5);"
