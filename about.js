...
var aboutFunc = function() {
  ...
  if(shown)
  {
    ...
    document.getElementById('disp').style = "-webkit-transition: 1s ease-in-out; transform: scale(1,1);"
    document.getElementById('about').innerHTML="";
    shown=false;;
  }
  else
  {
    document.getElementById('disp').style = "-webkit-transition: 1s ease-in-out; transform: scale(.5,.5);"
